    ...
    >
      <div className="teacher-analytics-page">
        <div className="page-header">
          <div>
            <h1 className="page-title">📊 Phân Tích & Báo Cáo</h1>
            <p className="page-subtitle">Theo dõi hiệu suất giảng dạy và tiến độ học sinh</p>
          </div>
        ...
        <div className="key-metrics">
          <div className="metric-card">
            ...
            <div className="metric-content">
              ...
              <div className="metric-trend positive">↑ 5% so với kỳ trước</div>
            </div>
          </div>
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              ...
              <div className="metric-label">Điểm TB chung</div>
              <div className="metric-trend positive">↑ 0.3 điểm</div>
            </div>
          </div>
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              ...
              <div className="metric-label">Nộp đúng hạn</div>
          ...
          <div className="insights-grid">
            ...
            <div className="insight-card info">
              ...
              <div className="insight-content">
                ...
                <p className="insight-text">
                  Tỷ lệ nộp trễ tăng nhẹ. Có thể cân nhắc điều chỉnh deadline hoặc nhắc nhở sớm hơn.
                </p>
              </div>
            </div>
          </div>
