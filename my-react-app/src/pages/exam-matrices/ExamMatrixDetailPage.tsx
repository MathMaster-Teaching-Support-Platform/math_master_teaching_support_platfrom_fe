...
export default function ExamMatrixDetailPage() {
  ...
  const { data: mappingData, refetch: refetchMappings } = useGetTemplateMappings(
    matrixId ?? '',
    !!matrixId
  );
                    ...
                    <tbody>
                      {mappings.map((mapping) => (
                        <tr key={mapping.id}>
                          ...
                          <td>
                            {cognitiveLevelLabel[mapping.cognitiveLevel] || mapping.cognitiveLevel}
                          </td>
                          ...
                          <td>
                            <div className="row" style={{ justifyContent: 'start' }}>
                              <button
                                className="btn secondary"
                                onClick={() => setPreviewTarget(mapping)}
                              >
                                Xem trước
                              </button>
                              {canEdit && (
