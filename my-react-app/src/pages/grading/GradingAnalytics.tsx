...
import { useExportGrades, useGradingAnalytics } from '../../hooks/useGrading';
          ...
          {analytics && (
            <>
                ...
                >
                  ...
                  <p className="muted" style={{ fontSize: '0.875rem', marginTop: 4 }}>
                    {analytics.totalSubmissions > 0
                      ? ((analytics.gradedSubmissions / analytics.totalSubmissions) * 100).toFixed(
                          0
                        )
                      : 0}
                    %
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    {Object.entries(analytics.scoreDistribution)
                      ...
                      .map(([range, count]) => {
                        ...
                        const rangeInfo = rangeLabels[range] || {
                          label: '',
                          ...
                          <div key={range}>
                            ...
                            >
                              <span style={{ fontWeight: 500 }}>
                                {range} -{' '}
                                <span style={{ color: rangeInfo.color }}>{rangeInfo.label}</span>
                              </span>
              ...
              {analytics.questionDifficulty &&
                Object.keys(analytics.questionDifficulty).length > 0 && (
                  <div
                    style={{
                      padding: 24,
                      backgroundColor: 'white',
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                      {Object.entries(analytics.questionDifficulty).map(
