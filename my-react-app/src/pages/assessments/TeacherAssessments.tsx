import { BookOpen, FileText, Lock, Pencil, RefreshCw, Search, Send, Trash2, X } from 'lucide-react';
          ...
          >
            ...
            {view === 'manage' && (
              <div style={{ display: 'grid', gap: '0.9rem' }}>
                <div className="row" style={{ gap: 8, alignItems: 'center' }}></div>
                      ...
                      return (
                        <article key={assessment.id} className="tassess-card">
                          ...
                          <header className="tassess-card__header">
                            <span className="tassess-card__status" data-status={assessment.status}>
