...
const BACKEND_MESSAGE_MAP: Record<string, string> = {
  ...
  'Failed to publish assessment': 'Không thể xuất bản bài kiểm tra.',
  'Failed to unpublish assessment': 'Không thể hủy xuất bản bài kiểm tra.',
  'Failed to close assessment': 'Không thể đóng bài kiểm tra.',
  'Failed to grade preview submission': 'Không thể chấm điểm thử.',
  'Failed to fetch publish summary': 'Không thể tải tóm tắt xuất bản.',
  ...
  'Failed to check publish permission': 'Không thể kiểm tra quyền xuất bản.',
  ...
  'Failed to export grades': 'Không thể xuất bảng điểm.',
