...
export const API_ENDPOINTS = {
  ...
  // ── OCR / Crawl-Data (SGK PDF — đi qua BE proxy /api/v1/crawl-data/**) ──
  OCR_BOOKS: '/v1/crawl-data/books',
  OCR_BOOK_UPLOAD: '/v1/crawl-data/books/upload',
  OCR_BOOK_DETAIL: (id: string) => `/v1/crawl-data/books/${id}`,
  OCR_BOOK_STATUS: (id: string) => `/v1/crawl-data/books/${id}/status`,
  OCR_BOOK_DELETE: (id: string) => `/v1/crawl-data/books/${id}`,
  OCR_BOOK_UPDATE: (id: string) => `/v1/crawl-data/books/${id}`,
  OCR_BOOK_CHAPTERS: (id: string) => `/v1/crawl-data/books/${id}/chapters`,
  OCR_BOOK_EXPORT_JSON: (id: string) => `/v1/crawl-data/books/${id}/export/json`,
  OCR_BOOK_EXPORT_MD: (id: string) => `/v1/crawl-data/books/${id}/export/md`,
  OCR_BOOK_EXPORT_CHUNKS: (id: string) => `/v1/crawl-data/books/${id}/export/chunks`,
  OCR_CHAPTER_DETAIL: (chapterId: string) => `/v1/crawl-data/chapters/${chapterId}`,
  OCR_CHAPTER_CREATE: '/v1/crawl-data/chapters',
  OCR_CHAPTER_UPDATE: (chapterId: string) => `/v1/crawl-data/chapters/${chapterId}`,
  OCR_CHAPTER_DELETE: (chapterId: string) => `/v1/crawl-data/chapters/${chapterId}`,
  OCR_CHAPTER_LESSONS: (chapterId: string) => `/v1/crawl-data/chapters/${chapterId}/lessons`,
  OCR_CHAPTER_HISTORY: (chapterId: string) => `/v1/crawl-data/chapters/${chapterId}/history`,
  OCR_LESSON_DETAIL: (lessonId: string) => `/v1/crawl-data/lessons/${lessonId}`,
  OCR_LESSON_CREATE: '/v1/crawl-data/lessons',
  OCR_LESSON_UPDATE: (lessonId: string) => `/v1/crawl-data/lessons/${lessonId}`,
  OCR_LESSON_DELETE: (lessonId: string) => `/v1/crawl-data/lessons/${lessonId}`,
  OCR_LESSON_CONTENT: (lessonId: string) => `/v1/crawl-data/lessons/${lessonId}/content`,
  OCR_LESSON_HISTORY: (lessonId: string) => `/v1/crawl-data/lessons/${lessonId}/history`,
  OCR_CONTENT_CREATE: '/v1/crawl-data/content',
  OCR_CONTENT_IMAGE_UPLOAD: '/v1/crawl-data/content/upload-image',
  OCR_CONTENT_DETAIL: (id: string) => `/v1/crawl-data/content/${id}`,
  OCR_CONTENT_UPDATE: (id: string) => `/v1/crawl-data/content/${id}`,
  OCR_CONTENT_DELETE: (id: string) => `/v1/crawl-data/content/${id}`,
  OCR_CONTENT_HISTORY: (id: string) => `/v1/crawl-data/content/${id}/history`,
